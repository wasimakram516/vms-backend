...
export class InitialSchema1774195960175 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('superadmin', 'admin', 'staff', 'visitor')`);
        await queryRunner.query(`CREATE TYPE "public"."users_stafftype_enum" AS ENUM('gate', 'kitchen', 'reception', 'security')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."custom_fields_inputtype_enum" AS ENUM('text', 'email', 'textarea', 'number', 'phone', 'select', 'radio', 'checkbox', 'date', 'time', 'file')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."audit_logs_action_enum" AS ENUM('create', 'update', 'delete', 'approve', 'reject', 'status_override', 'login', 'logout')`);
        ...
        await queryRunner.query(`ALTER TABLE "nda_templates" ADD CONSTRAINT "FK_f57849f579d9ed6d934e1e48073" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "nda_templates" ADD CONSTRAINT "FK_167b8d40c4a02de129dfb285156" FOREIGN KEY ("updatedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_nda_acceptances" ADD CONSTRAINT "FK_edfb5e780889320c4db85df235f" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_nda_acceptances" ADD CONSTRAINT "FK_150d6175232c69ad031e2362e84" FOREIGN KEY ("ndaTemplateId") REFERENCES "nda_templates"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_nda_acceptances" ADD CONSTRAINT "FK_98ceeefa643578d5aa9a3b9ed74" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_nda_acceptances" ADD CONSTRAINT "FK_8ec901a14048b5ea7f4f75646ac" FOREIGN KEY ("updatedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "badge_templates" ADD CONSTRAINT "FK_8740c20ead7348a30a7c51ade9c" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "badge_templates" ADD CONSTRAINT "FK_9e890787179c66e34a6eb67284a" FOREIGN KEY ("updatedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "qr_templates" ADD CONSTRAINT "FK_96889215363459a0af2b0c8ef98" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "qr_templates" ADD CONSTRAINT "FK_a0fd7d4d0653640ed0d3a4bab47" FOREIGN KEY ("updatedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "registrations" ADD CONSTRAINT "FK_b1d9b1fa775b09cc2284623646a" FOREIGN KEY ("ndaAcceptanceId") REFERENCES "user_nda_acceptances"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registrations" ADD CONSTRAINT "FK_b00010b17b38f2e751b9778f369" FOREIGN KEY ("badgeTemplateId") REFERENCES "badge_templates"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registrations" ADD CONSTRAINT "FK_0c30fadec0cb9ac9e569a5bd697" FOREIGN KEY ("qrTemplateId") REFERENCES "qr_templates"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registrations" ADD CONSTRAINT "FK_82d7f24c99a66acb967e7b13933" FOREIGN KEY ("approvedByUserId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registrations" ADD CONSTRAINT "FK_d25742f5db193288c208918489a" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registrations" ADD CONSTRAINT "FK_1be84060b881dcf77ef00e9b557" FOREIGN KEY ("updatedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "custom_fields" ADD CONSTRAINT "FK_3d5a5d59ca7fd5b965e129b127f" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "custom_fields" ADD CONSTRAINT "FK_c110f6eb57e7ea7b9fd62332324" FOREIGN KEY ("updatedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registration_field_values" ADD CONSTRAINT "FK_15ebc1a99932aa1a9c3c1d2b9a7" FOREIGN KEY ("registrationId") REFERENCES "registrations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registration_field_values" ADD CONSTRAINT "FK_01100e190bbf659018271d4f472" FOREIGN KEY ("customFieldId") REFERENCES "custom_fields"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registration_field_values" ADD CONSTRAINT "FK_c7fc5cbb55b1b4c97d31a974b7f" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registration_field_values" ADD CONSTRAINT "FK_57abcb300b3b1897a41b39f25f9" FOREIGN KEY ("updatedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registration_activity_logs" ADD CONSTRAINT "FK_94889f9012f93a2a5cfd5e1c625" FOREIGN KEY ("registrationId") REFERENCES "registrations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registration_activity_logs" ADD CONSTRAINT "FK_a4a7fc99b4750a9e422d8670ea2" FOREIGN KEY ("actorUserId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registration_activity_logs" ADD CONSTRAINT "FK_d3f2934712d5f4eb4bac7f1f13f" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "registration_activity_logs" ADD CONSTRAINT "FK_46fbd2e6b73f095c6c9e2ef9b6e" FOREIGN KEY ("updatedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "otp_verifications" ADD CONSTRAINT "FK_e601a887eb92f157c1e882ab707" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "otp_verifications" ADD CONSTRAINT "FK_257ea9c62ed4ca91de20fe21195" FOREIGN KEY ("updatedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "audit_logs" ADD CONSTRAINT "FK_f21950835fdbd146d6fbd8c7313" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "audit_logs" ADD CONSTRAINT "FK_893573d9f4553d10f80706705c9" FOREIGN KEY ("updatedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
